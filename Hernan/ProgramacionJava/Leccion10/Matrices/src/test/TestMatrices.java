...
public class TestMatrices {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Recorremos la matriz a través de un ciclo for");
        for(int fila = 0; fila < edades.length; fila++){
            for(int col = 0; col < edades[fila].length; col++){
                System.out.println("edades "+fila+"-"+col+": "+edades[fila][col]);
            }
        }
        // Es la sintaxis clásica
...
//        }
        ...
        personas[1][0] = new Persona("Natalia"); //Tarea
        personas[1][1] = new Persona("Hernán");
        personas[0][2] = new Persona("Javier");
        personas[1][2] = new Persona("Gustavo");
