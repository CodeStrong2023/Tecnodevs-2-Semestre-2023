...
for cocinar in cocina:
    print(cocinar, end=" ")#Variable cocinar, print hace saltos de linea y end= hace que no tenga esos saltos de linea

cocinalista = list(cocina)
cocinalista[0] = "Plato"
cocina =tuple(cocinalista) #encontramos solucion para modificar la tupla
print("\n",cocina) #salto de linea con \n

del cocina
print(cocina) #eliminamos tupla
