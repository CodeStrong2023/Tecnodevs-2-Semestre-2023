//Ejercicio 3: Leer 5 numeros por teclado, y almacenarlos en un arreglo y a continuacion
// realizar la media de los numeros positivios, la media de los negativos y contar en numero de ceros.
...
public class Arreglos_Ejercicio_3 {
    public static void main(String[] args) {
        ...
        float negativos=0,positivios=0,mediaNegativos,mediaPositivos;
        ...
        if(conteo_positivos == 0){
            ...
            mediaPositivos = positivios/conteo_positivos;
